package com.september.common.utils.file;
...
import com.september.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = SeptemberConfig.getProfile();
    ...
    {
        int dirLastIndex = SeptemberConfig.getProfile().length() + 1;
